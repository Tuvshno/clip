# Clip
This project streamlines and improves the clip making proces for content creators and editors on social media platforms.

## Architecture
Core/App project architecture. There are two included projects - one called _Core_, and one called _App_. [Premake](https://github.com/premake/premake-core) is used to generate project files.
